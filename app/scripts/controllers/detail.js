...
angular.module('topazApp')
  .controller('DetailCtrl', function($scope, $location) {
    ...
    var doubleData = parseData(bluemixData) 
    var doubleDataTwo = parseData(bluemixDataTwo)
    ...
    function randomDataset() {
      ...
      var arrayPushed = []
      doubleData.forEach(function(d, i) {
        arrayPushed.push({
          'axis': d.name,
          'value': d.percentage
        })
      ...
      var arrayPushedTwo = []
      doubleDataTwo.forEach(function(d, i) {
        arrayPushedTwo.push({
          'axis': d.name,
          'value': 0.5
        })
